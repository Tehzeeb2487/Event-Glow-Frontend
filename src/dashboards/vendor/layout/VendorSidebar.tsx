...
import {
  LayoutDashboard, Briefcase, CalendarCheck, DollarSign, User as UserIcon, LogOut, Store,
} from "lucide-react";
...
const navItems = [
  ...
  { to: "/vendor/services", label: "My Services", icon: Briefcase },
...
export default function VendorSidebar({
  ...
  const handleLogout = () => {
    confirmToast({
      message: "Logout?",
      description: "Are you sure you want to log out of the Vendor panel?",
      confirmLabel: "Logout",
      variant: "destructive",
      onConfirm: async () => {
  ...
  return (
    <>
      ...
      >
        <Link to="/vendor" onClick={onClose} className="flex h-16 items-center gap-2 border-b px-5 hover:bg-muted/50 transition-colors">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[hsl(180,60%,45%)] to-[hsl(210,70%,50%)] text-primary-foreground">
