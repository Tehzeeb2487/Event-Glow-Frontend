...
export default function VendorLayout() {
  ...
  if (
    ...
    location.pathname !== "/vendor/profile-setup"
  ) {
    return <Navigate to="/vendor/profile-setup" replace />;
  }
  if (user.role !== "vendor") return <Navigate to="/login" replace />;

  return (
    <div className="flex min-h-screen bg-background">
      <VendorSidebar open={sidebarOpen} onClose={() => setSidebarOpen(false)} collapsed={sidebarCollapsed} />
